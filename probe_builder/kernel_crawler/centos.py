...
class CentosMirror(repo.Distro):
    def get_mirrors(self, crawler_filter):
        mirrors = [
            ...
            rpm.RpmMirror('http://archive.kernel.org/centos-vault/', 'os/{}/'.format(crawler_filter.machine), v7_only),
            rpm.RpmMirror('http://archive.kernel.org/centos-vault/', 'updates/{}/'.format(crawler_filter.machine), v7_only),
