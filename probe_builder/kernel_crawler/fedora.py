...
class FedoraMirror(repo.Distro):
    def get_mirrors(self, crawler_filter):
        mirrors = [
            ...
            rpm.RpmMirror('https://fedora.osuosl.org/linux/releases/', 'Everything/{}/os/'.format(crawler_filter.machine), repo_filter),
            ...
            rpm.RpmMirror('https://fedora.osuosl.org/linux/updates/', 'Everything/{}/'.format(crawler_filter.machine), repo_filter),
        ]
        return mirrors
